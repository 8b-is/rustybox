...
[![Sponsor](https://img.shields.io/badge/Sponsor-%E2%9D%A4-db61a2?logo=githubsponsors&logoColor=white)](https://github.com/sponsors/8b-is)
...
[![kernel8 Userland](https://img.shields.io/badge/Userland-kernel8-0055ff?logo=github&logoColor=white)](https://github.com/8b-is/kernel8)
[![vakedkernel Userland](https://img.shields.io/badge/Userland-vakedkernel%20%F0%9F%9C%82-ff4500)](https://github.com/8b-is/rustybox)
...
> **Built in the open — [♥ sponsor the resurrection](https://github.com/sponsors/8b-is).**

RustyBox is a free-range, non-GMO fork of [BusyBox](https://busybox.net/) written entirely in [Rust](https://www.rust-lang.org/). It serves as the official userland for [kernel8](https://github.com/8b-is/kernel8) and **vakedkernel 🜂**, as well as the embedded Linux sandbox for [Entheai](https://github.com/entropy-om/entheai). It includes all your favorite commands like `ls`, `mount`, `grep`, `find`, and `top`, but without a single line of C code. Like BusyBox, it covers the basic utilities you need to stand up a small Linux userland or agent sandbox, and fits into a single, fully-static ~4MB binary (UPX compressed).
...
### [→ Sponsor on GitHub](https://github.com/sponsors/8b-is)

One [GitHub Sponsors](https://github.com/sponsors/8b-is) listing funds
