...
| **watch** | loop and periodic execution | in-house safe rewrite ✅ |
| **xargs** | build and execute command lines | in-house safe rewrite ✅ |

**Stay transpiled for now**: Candidates for
