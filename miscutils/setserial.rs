...
pub type SetSerialCmd = libc::c_uint;
pub const CMD_FLAG_LAST: SetSerialCmd = 15;
pub const CMD_FLAG_FIRST: SetSerialCmd = 6;
pub const CMD_AUTOCONFIG: SetSerialCmd = 23;
pub const CMD_WAIT: SetSerialCmd = 22;
pub const CMD_DELAY: SetSerialCmd = 21;
pub const CMD_BASE: SetSerialCmd = 20;
pub const CMD_UART: SetSerialCmd = 19;
pub const CMD_DIVISOR: SetSerialCmd = 18;
pub const CMD_IRQ: SetSerialCmd = 17;
pub const CMD_PORT: SetSerialCmd = 16;
pub const CMD_FLAG_LOW_LATENCY: SetSerialCmd = 15;
pub const CMD_FLAG_CALLOUT_NOHUP: SetSerialCmd = 14;
pub const CMD_FLAG_PGRP_LOCKOUT: SetSerialCmd = 13;
pub const CMD_FLAG_SESSION_LOCKOUT: SetSerialCmd = 12;
pub const CMD_FLAG_SPLIT_TERMIOS: SetSerialCmd = 11;
pub const CMD_FLAG_AUTO_IRQ: SetSerialCmd = 10;
pub const CMD_FLAG_SKIP_TEST: SetSerialCmd = 9;
pub const CMD_FLAG_NUP_NOTIFY: SetSerialCmd = 8;
pub const CMD_FLAG_FOURPORT: SetSerialCmd = 7;
pub const CMD_FLAG_SAK: SetSerialCmd = 6;
pub const CMD_SPD_CUST: SetSerialCmd = 5;
pub const CMD_SPD_WARP: SetSerialCmd = 4;
pub const CMD_SPD_SHI: SetSerialCmd = 3;
pub const CMD_SPD_VHI: SetSerialCmd = 2;
pub const CMD_SPD_HI: SetSerialCmd = 1;
pub const CMD_SPD_NORMAL: SetSerialCmd = 0;
#[inline(always)]
unsafe fn bb_strtol(
