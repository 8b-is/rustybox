...
use libc::termios;
use libc::FILE;
pub type HexEditFatalSigs = libc::c_uint;
pub const BB_FATAL_SIGS: HexEditFatalSigs = 117503054;
pub type HexEditKeyCode = libc::c_int;
pub const KEYCODE_BUFFER_SIZE: HexEditKeyCode = 16;
pub const KEYCODE_CURSOR_POS: HexEditKeyCode = -256;
pub const KEYCODE_ALT_D: HexEditKeyCode = -45;
pub const KEYCODE_ALT_BACKSPACE: HexEditKeyCode = -44;
pub const KEYCODE_ALT_LEFT: HexEditKeyCode = -37;
pub const KEYCODE_ALT_RIGHT: HexEditKeyCode = -36;
pub const KEYCODE_CTRL_LEFT: HexEditKeyCode = -69;
pub const KEYCODE_CTRL_RIGHT: HexEditKeyCode = -68;
pub const KEYCODE_D: HexEditKeyCode = -13;
pub const KEYCODE_BACKSPACE: HexEditKeyCode = -12;
pub const KEYCODE_PAGEDOWN: HexEditKeyCode = -11;
pub const KEYCODE_PAGEUP: HexEditKeyCode = -10;
pub const KEYCODE_DELETE: HexEditKeyCode = -9;
pub const KEYCODE_INSERT: HexEditKeyCode = -8;
pub const KEYCODE_END: HexEditKeyCode = -7;
pub const KEYCODE_HOME: HexEditKeyCode = -6;
pub const KEYCODE_LEFT: HexEditKeyCode = -5;
pub const KEYCODE_RIGHT: HexEditKeyCode = -4;
pub const KEYCODE_DOWN: HexEditKeyCode = -3;
pub const KEYCODE_UP: HexEditKeyCode = -2;
